...
<div>
  ...
  <div class="line">
    ...
    <form style="display:inline-block" name="predictVaccine" method="get" action="predictVaccine">
      <div class="asd" onClick="document.forms['predictVaccine'].submit();">
        <img src="${pageContext.request.contextPath}/resources/img/predict.JPG" alt="백신예측"width="150px" height="150px"><br><b>백신</b>
      </div>
    </form>
    ...
    <form style="display:inline-block">
      <div class="asd" onclick= moveURL2() class="linkToCDC">
        <img src="${pageContext.request.contextPath}/resources/img/cdc.JPG" alt="잘병관리본부"width="150px" height="150px"><br><b>질병관리본부</b>
      </div>
    </form>
    <script>
	    function moveURL() {
